...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('configuration_command', function (Blueprint $table) {
            $table->id();
            ...
            $table->float('min_wind_speed')->nullable();;
            $table->float('max_soil_temp')->nullable();;
            $table->float('max_soil_humidity')->nullable();;
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('configuration_command');
    }
};
